...

{
    ...
    {
        //数据库连接字符串 
        public static string Conn = "Database=dbtest;Data Source=localhost;User Id=root;Password=123456;pooling=false;CharSet=utf8;port=3306"; //XXX的为修改项
        ...
        {
            string res = "ok";
            //using System.Data.SqlClient; //处理SQL Server对象
            try
            {
                using (MySqlConnection conn = new MySqlConnection(Conn))
                {
                    //open就是在连接数据库，如果连接成功，那么这句话会顺利结束，如果连接不成功，就会出一个异常
                    conn.Open();
                }
            }
            catch (Exception e)
...
/// </summary> 
/// <param name="Conn">一个有效的连接字符串</param> 
